= {subject}
:subject: Advanced OpenShift Networking Troubleshooting and Configuration
:description:  Advanced OpenShift Networking Troubleshooting and Configuration
Ricardo Taniguchi <jtaniguc@redhat.com>
:doctype: book
:customer:  GLS
